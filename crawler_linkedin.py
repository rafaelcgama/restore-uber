...
from utils import write_file, rename_file, create_filepath
...
class LinkedInCrawler(Crawler):
    ...
    def save_data(self, final=False):
        ...
        new_filepath = create_filepath(filename, folder='data_in_progress')
        ...
        if not len(old_filepath):
            ...
            final_pathname = self.create_filepath(filename, folder='data_raw', final=True)
